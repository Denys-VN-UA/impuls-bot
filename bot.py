...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8326717430:AAFfyaIk4o3X9UgFkLaTTRSt07jnldzr6kM")
TWELVE_API_KEY = os.getenv("TWELVE_API_KEY", "b52bca747e0f45b7b3a196c17a7b8e6b")

# ID канала вида -100xxxxxxxxxx (число, без кавычек)
CHANNEL_ID = -1003884977983

# ТВОЙ user_id (только ты можешь писать команды боту + подтверждать кнопки)
OWNER_ID = 712017858
